...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="courseunit" name="courseunit" placeholder="Credits" value="<?php echo htmlentities($row['courseUnit']);?>" required />
  </div>  

<div class="form-group">
    <label for="seatlimit">Faculty Name  </label>
    <input type="text" class="form-control" id="seatlimit" name="seatlimit" placeholder="Faculty Name " value="<?php echo htmlentities($row['noofSeats']);?>" required />
  </div>  
