...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="courseunit" name="courseunit" placeholder="Credits" required />
  </div> 

<div class="form-group">
    <label for="seatlimit">Faculty Name </label>
    <input type="text" class="form-control" id="seatlimit" name="seatlimit" placeholder="Faculty Name " required />
  </div>   
