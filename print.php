...
{?>
   ...
   <?php } ?>
            ...
            <tr class="details">
                ...
                <td>
                  <?php echo htmlentities($row['cseat']);?>
                </td>
            </tr>
